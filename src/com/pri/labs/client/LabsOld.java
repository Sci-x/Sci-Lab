...
public class LabsOld implements EntryPoint
{

 // FCKEditor like colors
 private static String[] colors = new String[] { "FF6600", "808000", "008000", "008080", "0000FF", "666699", "FF0000", "FF9900", "99CC00", "339966",
   "33CCCC", "3366FF", "800080", "969696", "FF00FF", "FFCC00", "FFFF00", "00FF00", "00FFFF", "00CCFF", "993366", "C0C0C0", "FF99CC", "FFCC99", "FFFF99",
...
//    column.addMember(placeHolder, 0); // add to top
    ...
    outline.setBorder("1px solid navy");
    outline.draw();
    outline.bringToFront();

    outline.animateRect(newPortlet.getPageLeft(), newPortlet.getPageTop(), newPortlet.getVisibleWidth(), newPortlet.getViewportHeight(),
...
//        placeHolder.destroy();
  ...
  ButtonItem layoutEditor = new ButtonItem("Edit layout");
  layoutEditor.setIcon("silk/application_side_contract.png");
  layoutEditor.setAutoFit(true);
  layoutEditor.setStartRow(false);
  layoutEditor.setEndRow(false);

  layoutEditor.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler()
  {
   public void onClick(com.smartgwt.client.widgets.form.fields.events.ClickEvent event)
   {
    vLayout.getParent();
...
//    VLayout newLay = new VLayout(2);
//    newLay.addMember(new LayoutPanel("100%","100%"));
//    newLay.setWidth100();
//    newLay.setHeight100();
//
//    newLay.draw();
  ...
  form.setItems(numColItem, addPortlet, addColumn, removeColumn, layoutEditor);
 ...
 private class PortalColumn extends VStack
 {
  ...
  public PortalColumn()
  {
   ...
   placeHolderProperties.setBorder("2px solid yellow");
